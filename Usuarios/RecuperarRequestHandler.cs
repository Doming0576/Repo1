...
public static class RecuperarRequestHandler{
    public static IResult Recuperar(Recuperar Datos){
        ...
        message.From= new System.Net.Mail.MailAddress("domingoalfonsohernandez@gmail.com");
        message.Body="Tu contraseña es: "+usuarioExistente.Password;
        message.To.Add(usuarioExistente.Correo);
        System.Net.Mail.SmtpClient smtp= new System.Net.Mail.SmtpClient();
        smtp.Credentials=new System.Net.NetworkCredential("domingoalfonsohernandez@gmail.com","oior zsqb fntm bjbe");
        smtp.Port=25;
