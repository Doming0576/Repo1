...
app.MapGet("/Calificaciones/0",RequestHandlers.MostrarCalificacionesAlumno);
app.MapPost("/operaciones",OperacionesRequestHndler.Calcular);
app.MapPost("/control-escolar/alumnos", AlumnosRequestHandlers.ListarAlumnos);
...
app.MapPost("/categorias",CategoriasRequestHandler.Crear);
app.MapGet("/categorias/crear",CategoriasRequestHandler.Listar);
